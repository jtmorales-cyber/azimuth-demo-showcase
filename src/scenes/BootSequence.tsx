  ...
  return (
    ...
    >
      ...
      {/* AZIMUTH wordmark — below the logo, just past center.
          Flex wrapper spans full width so the inner span can use marginRight: -letterSpacing
          to strip the trailing letter-spacing from the layout box, putting the visible glyphs
          dead-center under the logo. */}
      <motion.div
        initial={{ opacity: 0, y: 8 }}
        animate={{ opacity: 0.55, y: 0 }}
        transition={{ delay: 1.4, duration: 0.9, ease: 'easeOut' }}
        className="absolute left-0 right-0 flex justify-center font-inter uppercase"
        style={{
          top: '62%',
